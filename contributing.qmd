...
Once the pull request is opened, and the github `preview.yml` workflow runs ("Deploy PR previews"), you should have a preview available for review at https://developmentseed.org/stacmlguide/pr-preview/pr-<YOUR-PR-NUMBER-HERE>.
